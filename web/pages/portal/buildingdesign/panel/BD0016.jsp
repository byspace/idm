...
<div class="box08_left">
	<div class="box07_left_top">
		<ul id="head">
			<li class="nav_left">
				<ul>
					<li class="nav_left_top" style="background: url('<spring:url value="/static/img/icon01.png"/>') no-repeat top left;"><a href="<spring:url value="/portal/topic/list/TP0312"/>" target="_blank"><span>建筑摄影</span></a></li>
			<li class="nav_left_bottom" style="background: url('<spring:url value="/static/img/icon02.png"/>') no-repeat;"><span>Photos</span></li>
		</ul>
		</li>
		<li class="nav_right" style="background:url('<spring:url value="/static/img/btn_bg01.png"/>') no-repeat;"><a href="<spring:url value="/portal/topic/list/TP0312"/>" target="_blank">更多.</a></li>
		</ul>
		<div class="clear"></div>
	</div>
	<div class="box07_left_bottom">
		<div class="box07_left_bottom_left">
			<c:forEach items="${photoList}" var="article" begin="0" end="0">
				<div class="box_top">
					<ul >
			...
			<div class="text">
				<ul class="left_list" >
					<c:forEach items="${photoList}" var="article" begin="1" end="7">
