...
<div class="details_waup">
	...
	<div class="details_list">
		<table class="aarticle" cellpadding="0" cellspacing="0">
			<tbody><tr>
				<td class="title">${article.subject}</td></tr>
			<tr><td class="lline"></td></tr>
			<tr><td class="time">${article.publishDate}&nbsp;&nbsp;文章来源：<font class="time_source">${article.source}</font></td></tr><tr><td class="time">文章类型：<font class="time_leixing">${article.articleType.name}</font>&nbsp;&nbsp;内容分类：<font class="time_fenlei">${article.category.name}</font></td></tr>
			<tr><td class="content" id="zoom"><br>
