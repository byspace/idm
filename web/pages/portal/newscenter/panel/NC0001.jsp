...
<div class="main_box01_left">
	<div class="indexCon fl">
		<div class="flashBanner">
			...
			<div class="mask">
				<c:forEach items="${newsAndInfoPicturePanel.articleList}" var="article">
	...
	<div class="news_info">
		<div class="main_box01_right_top">
			<ul class="title">
				<li class="nav_left">
					<ul>
						<li class="nav_left_top" style="background:url('<spring:url value="/static/img/icon01.png"/>') no-repeat top left;"><a href="http://www.93idm.com/static/column/infocenter/newsinfo.html/infocenter" target="_blank"><span>新闻资讯</span></a></li>
			...
			<li class="nav_right"  style="background:url('<spring:url value="/static/img/btn_bg01.png" />') no-repeat;"><a href="<spring:url value="/portal/topic/listArticle/9" />">更多.</a></li>
			</ul>
			<div class="clear"></div>
		</div>
		<div class="main_box01_right_bottom">
			<ul class="con_news">
				...
				<c:forEach items="${newsAndInfoArticles}" begin="0" end="6" var="article" varStatus="status">
			...
			<ul class="con_news">
				<c:forEach items="${newsAndInfoArticles}" begin="7" end="12" var="article" varStatus="status">
					<li><a href="<spring:url value="/portal/article/view/${article.id}"/>" target="_blank">
						<c:if test="${status.first}"><strong></c:if>
						[${article.category.name}]${article.subject}
						<c:if test="${status.first}"></strong></c:if>
