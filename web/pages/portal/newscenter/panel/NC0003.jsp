...
<div class="main_box02">
	<div class="main_box02_top">
		<ul class="title">
			<li class="nav_left">
				<ul>
					<li class="nav_left_top" style="background:url('<spring:url value="/static/img/icon01.png"/>') no-repeat top left;"><a href="<spring:url value="/portal/topic/viewArticle/11"/>" target="_blank"><span>设计前沿</span></a></li>
			...
			<li class="nav_right"  style="background:url('<spring:url value="/static/img/btn_bg01.png" />') no-repeat;" id="desighner"><a href="<spring:url value="/portal/topic/listArticle/11"/>" target="_blank">更多.</a></li>
		</ul>
		<div class="clear"></div>
	</div>
	<div class="main_box02_con">
		<div class="main_box02_left">
			<ul class="con_news">
				<c:forEach items="${designFrontList}" var="article" begin="0" end="9" varStatus="status">
		...
		<div class="main_box02_right">
			<div class="work">
				...
				<c:forEach items="${designFrontList}" var="article" begin="10" end="19" varStatus="status">
					<ul>
