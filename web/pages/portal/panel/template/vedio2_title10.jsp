			...
			<ul>
				<#list vi25 as article>
					<li style="margin-top: 5px">
						...
						<a title="${article.subject}" href="${ROOT_URL}/portal/article/viewVideo/${article.id}" target="_blank"  style="max-width: ${imageWidth}px; width: ${imageWidth}px;">${article.subject}</a>
					</li>
				</#list>
			</ul>
		</div>
